...
env = CogEnvDecoder(env_name="stage2/linux_v3.0/cog_sim2real_env.x86_64", no_graphics=False, 
...
for i in range(num_episodes):
    ...
    observation = env.reset(fri_cor=0.5, KP=8, KI=0, KD=2, VK1=0.375, M=3.4, Wheel_I=0.0125)
